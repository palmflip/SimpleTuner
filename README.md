...
# SimpleTuner для Flux LoRA на A100 SXM

Готовая настройка для тренировки высококачественных LoRA персонажей на A100 SXM с разрешением 1024x1024.

## 🚀 Быстрый старт

### Для новичков (автоустановка)
```bash
git clone <repo>
cd SimpleTuner
./setup_a100.sh  # Автоматическая установка всех зависимостей
```

### Для опытных пользователей
1. [Установка и настройка](INSTALL_A100.md) - подробная инструкция
2. [Быстрый старт](QUICKSTART_A100.md) - запуск за 5 минут
3. [Подробная документация](README_TRAINING.md) - все настройки

## 📋 Что включено

- ✅ **Готовые конфиги для A100** - оптимизированы под CUDA 8.0
- ✅ **Автоустановка** - скрипт `setup_a100.sh` настроит всё сам
- ✅ **Две версии тренировки** - быстрая (20 мин) и качественная (45 мин)
- ✅ **Документация на русском** - пошаговые инструкции
- ✅ **Примеры датасетов** - как правильно описывать изображения
- ✅ **Troubleshooting** - решения частых проблем

## 🎯 Результаты

| Вариант | Время | Качество | VRAM | Размер LoRA |
|---------|--------|----------|------|-------------|
| Быстрый | 20 мин | Хорошее | 32-36GB | ~50MB |
| Качественный | 45 мин | Отличное | 35-38GB | ~150MB |

## 🔧 Требования

- **GPU**: A100 SXM 40GB/80GB
- **CUDA**: 11.8+ 
- **Python**: 3.10+
- **RAM**: 32GB+
...
| Файл | Описание |
|------|----------|
| [INSTALL_A100.md](INSTALL_A100.md) | Полная инструкция по установке |
| [QUICKSTART_A100.md](QUICKSTART_A100.md) | Быстрый старт за 5 минут |
| [README_TRAINING.md](README_TRAINING.md) | Подробности тренировки |
| [dataset_example.txt](dataset_example.txt) | Примеры описаний изображений |

## 🛠️ Файлы конфигурации

| Файл | Назначение |
|------|-----------|
| `config_a100.json` | Качественная тренировка |
| `config_a100_fast.json` | Быстрая тренировка |
| `train_flux_a100.sh` | Скрипт качественной тренировки |
| `train_flux_a100_fast.sh` | Скрипт быстрой тренировки |
| `setup_a100.sh` | Автоматическая установка |

## ⚡ Запуск одной командой

```bash
# Полная установка и первый запуск
git clone <repo> && cd SimpleTuner
./setup_a100.sh
# ... поместите датасет в dataset/ ...
./train_flux_a100_fast.sh
```

## 🎯 Оптимизации для A100

- **CUDA 8.0 архитектура** - правильная настройка для A100
- **Gradient Accumulation** - эффективное использование VRAM
- **bf16 precision** - максимальная производительность
- **Автоматические проверки** - валидация датасета и модели
- **Torch Compile** - ускорение тренировки

---

**SimpleTuner + A100 = идеальная комбинация для Flux LoRA! 🚀**
